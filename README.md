...
The webapi we use is 'http://www.tvmaze.com/api'. With this you can request data about TV shows. This example project consists of a Windows Service based on Topshelf. Periodically a job starts that downloads data from the webapi. We store these via an entity framework in a sql database.
